#!/usr/bin/python3
"""module creates unnit tests for db_storage"""
import pep8
import models
import MySQLdb
import unittest
...
class TestDBStorage(unittest.TestCase):
    ...
    def test_all_cls(self):
        """Test all methods with specified cls"""
    ...
    def test_delete_none(self):
        """Test delete correctness with None."""
        try:
